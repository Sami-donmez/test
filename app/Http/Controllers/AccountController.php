...
class AccountController extends Controller {
    ...
    public function create(Request $request) {
        if (!$request->ajax()) {
            ...
            return view('account.modal.create');
        }
    }
    ...
    public function show(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            return view('account.view', compact('account', 'id'));
        } else {
            return view('account.modal.view', compact('account', 'id'));
        }
    ...
    public function edit(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            ...
            return view('account.modal.edit', compact('account', 'id'));
        }
