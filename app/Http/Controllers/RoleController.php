...
class RoleController extends Controller
{
    ...
    public function create(Request $request)
    {
        if( ! $request->ajax()){
           ...
           return view('user.role.modal.create');
        }
    }
    ...
    public function show(Request $request,$id)
    {
        $role = Role::find($id);
        if(! $request->ajax()){
            return view('user.role.view',compact('role','id'));
        }else{
            return view('user.role.modal.view',compact('role','id'));
        }
    ...
    public function edit(Request $request,$id)
    {
        $role = Role::find($id);
        if(! $request->ajax()){
            return view('user.role.edit',compact('role','id'));
        }else{
            return view('user.role.modal.edit',compact('role','id'));
        }
