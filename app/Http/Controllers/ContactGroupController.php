...
class ContactGroupController extends Controller {
    ...
    public function index() {
        ...
        return view('contacts.contact_group.list', compact('contactgroups'));
    }
    ...
    public function create(Request $request) {
        if (!$request->ajax()) {
            return view('contacts.contact_group.create');
        } else {
            return view('contacts.contact_group.modal.create');
        }
    }
    ...
    public function show(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            return view('contacts.contact_group.view', compact('contactgroup', 'id'));
        } else {
            return view('contacts.contact_group.modal.view', compact('contactgroup', 'id'));
        }
    ...
    public function edit(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            return view('contacts.contact_group.edit', compact('contactgroup', 'id'));
        } else {
            return view('contacts.contact_group.modal.edit', compact('contactgroup', 'id'));
        }
